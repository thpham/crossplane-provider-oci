...
type LaunchDetailsParameters struct {
	...
	// (Applicable when instance_type=compute) The platform configuration requested for the instance.
	// +kubebuilder:validation:Optional
...
type LaunchDetailsPlatformConfigParameters struct {
	...
	// (Applicable when type=AMD_MILAN_BM | AMD_MILAN_BM_GPU | AMD_ROME_BM | AMD_ROME_BM_GPU | GENERIC_BM | INTEL_ICELAKE_BM | INTEL_SKYLAKE_BM) Whether symmetric multithreading is enabled on the instance. Symmetric multithreading is also called simultaneous multithreading (SMT) or Intel Hyper-Threading.
	// +kubebuilder:validation:Optional
